...
public class CpListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courses_array[0] = "Art History";
        courses_array[1] = "Catechetics";
        courses_array[2] = "Classics";
        courses_array[3] = "Communication";
        courses_array[4] = "Ethnic Studies";
        courses_array[5] = "Liberal Studies";
        ...
        lv_courses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(position == 0){
                    ...
                    Intent coa_intent = new Intent(CpListView.this, ProfessorDescription.class);
                    coa_intent.putExtra("key0", c00);
                    startActivity(coa_intent);
                }
                //If the user selects a course from Continuing Education
                else if(position == 1){
                    //Start a new activity that will contain related departments
                    Intent ce_intent = new Intent(CpListView.this, ProfessorDescription.class);
                    ce_intent.putExtra("key0", c01);
                    startActivity(ce_intent);
                }
                //If the user selects a course from Counseling Psychology
                else if(position == 2){
                    //Start a new activity that will contain related departments
                    Intent cp_intent = new Intent(CpListView.this, ProfessorDescription.class);
                    cp_intent.putExtra("key0", c02);
                    startActivity(cp_intent);
                }
                //If the user selects a course from Leavy School of Business
                else if(position == 3){
                    //Start a new activity that will contain related departments
                    Intent lsob_intent = new Intent(CpListView.this, ProfessorDescription.class);
                    lsob_intent.putExtra("key0", c03);
                    startActivity(lsob_intent);
                }
                //If the user selects a course from School of Engineering
                else if(position == 4){
                    //Start a new activity that will contain related departments
                    Intent soe_intent = new Intent(CpListView.this, ProfessorDescription.class);
                    soe_intent.putExtra("key0", c04);
                    startActivity(soe_intent);
                }
                //If the user selects a course from School of Law
                else{
                    //Start a new activity that will contain related departments
                    Intent sol_intent = new Intent(CpListView.this, ProfessorDescription.class);
                    sol_intent.putExtra("key0", c05);
