...
public class CoaListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courses_array[0] = "Anthropology";
        courses_array[1] = "Biology";
        courses_array[2] = "Chemistry";
        courses_array[3] = "Dance";
        courses_array[4] = "Economics";
        courses_array[5] = "History";
        ...
        lv_courses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(position == 0){
                    ...
                    Intent coa_intent = new Intent(CoaListView.this, ProfessorDescription.class);
                    coa_intent.putExtra("key0", a00);
                    startActivity(coa_intent);
                }
                //If the user selects a course from Continuing Education
                else if(position == 1){
                    //Start a new activity that will contain related departments
                    Intent ce_intent = new Intent(CoaListView.this, ProfessorDescription.class);
                    ce_intent.putExtra("key0", a01);
                    startActivity(ce_intent);
                }
                //If the user selects a course from Counseling Psychology
                else if(position == 2){
                    //Start a new activity that will contain related departments
                    Intent cp_intent = new Intent(CoaListView.this, ProfessorDescription.class);
                    cp_intent.putExtra("key0", a02);
                    startActivity(cp_intent);
                }
                //If the user selects a course from Leavy School of Business
                else if(position == 3){
                    //Start a new activity that will contain related departments
                    Intent lsob_intent = new Intent(CoaListView.this, ProfessorDescription.class);
                    lsob_intent.putExtra("key0", a03);
                    startActivity(lsob_intent);
                }
                //If the user selects a course from School of Engineering
                else if(position == 4){
                    //Start a new activity that will contain related departments
                    Intent soe_intent = new Intent(CoaListView.this, ProfessorDescription.class);
                    soe_intent.putExtra("key0", a04);
                    startActivity(soe_intent);
                }
                //If the user selects a course from School of Law
                else{
                    //Start a new activity that will contain related departments
                    Intent sol_intent = new Intent(CoaListView.this, ProfessorDescription.class);
                    sol_intent.putExtra("key0", a05);
